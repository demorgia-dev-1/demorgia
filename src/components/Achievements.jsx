...
const MUTED_WHITE_2 = "rgba(255,255,255,0.75)";
    ...
    >
      ...
      >
        ...
        <Box sx={{ maxWidth: { xs: "100%", sm: 320 } }}>
          ...
          >
            {align === "left" && (
              <Icon sx={{ fontSize: { xs: 18, sm: 20 }, color: GREEN }} />
            )}
            <Typography
              variant="h6"
              fontWeight={700}
              sx={{ color: WHITE, fontSize: { xs: "0.95rem", sm: "1.25rem", md: "1.35rem" } }}
            >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M60 40 h120 v22 a40 40 0 0 1 -40 40 h-40 a40 40 0 0 1 -40 -40 z" fill={WHITE} stroke={GREEN} strokeWidth="3" />
        <path d="M60 50 a35 35 0 0 0 -20 60" fill="none" stroke={GREEN} strokeWidth="3" />
        <path d="M180 50 a35 35 0 0 1 20 60" fill="none" stroke={GREEN} strokeWidth="3" />
        <rect x="105" y="100" width="30" height="26" rx="4" fill={GREEN} />
        <rect x="85"  y="126" width="70" height="12" rx="6" fill={WHITE} />
        <rect x="70"  y="140" width="100" height="18" rx="8" fill="#073046" />
        <circle cx="120" cy="88" r="16" fill={WHITE} stroke={GREEN} strokeWidth="3" />
...
const Achievements = () => {
  ...
  const leftSide = six.slice(0, 3);   
  const rightSide = six.slice(3, 6);  

  return (
    <Box sx={{ pt: { xs: 6, md: 10 }, pb: { xs: 4, md: 8 }, bgcolor: BG, color: WHITE }}>
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 3, md: 5 }, px: 2 }}>
        ...
        >
          <Typography
            ...
            fontWeight="bold"
            component="h2"
            sx={{ fontSize: { xs: "1.4rem", sm: "1.7rem", md: "2rem" }, color: WHITE }}
          >
            Our Key <Box component="span" sx={{ color: GREEN }}>Achievements</Box>
          </Typography>
          <Box
