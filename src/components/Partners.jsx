...
import { Box, Typography, Container, Tooltip, useTheme, Button, Card, CardMedia, CardContent } from "@mui/material";
        ...
        >
          ...
          {/* <Typography
           ...
           sx={{
            ...
            More than <span sx={{color: "blue"}}>12+ years in the market</span> have allowed us to understand and serve different sectors. 
          </Typography> */}
          <Typography
  align="center"
  sx={{
          ...
          >
            {images.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                style={{
                  flex: "1 1 calc(25% - 24px)", // 4 per row with 24px spacing
                  minWidth: 260, // fallback for smaller screens
                  maxWidth: 320,
                }}
              >
                <Card
